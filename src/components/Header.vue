        ...
        <div class="flex items-center justify-between h-16">
          <div class="flex items-center">
            <!--             <div class="flex-shrink-0">
              <img class="h-8 w-8" src="../assets/logo.png" alt="Workflow logo" />
            </div>-->
            <div class="hidden md:block">
              <div class="flex items-baseline">
                <router-link
                  to="/"
                  active-class="text-white bg-gray-900 focus:outline-none focus:text-white"
                  class="px-3 py-2 rounded-md text-sm font-medium text-gray-300 hover:text-white focus:outline-none focus:text-white"
                >Dashboard</router-link>
                <router-link
                  to="/groups"
                  active-class="text-white bg-gray-900 focus:outline-none focus:text-white"
                  class="ml-4 px-3 py-2 rounded-md text-sm font-medium text-gray-300 hover:text-white focus:outline-none focus:text-white"
                >groups</router-link>
                <router-link
                  to="/about"
                  active-class="text-white bg-gray-900 focus:outline-none focus:text-white"
...
export default {
  ...
  setup() {
    ...
    const toggleProfileMenu = () => (state.profileOpen = !state.profileOpen);
